...
[![My Skills](https://skillicons.dev/icons?i=js,ts,tailwind,react,vite,next,expressjs,nodejs,mongodb,md,git,github,vscode,styledcomponents,postman,arduino,bash,bootstrap,bun,c,django,docker,go,kafka,ubuntu,linux,latex,py,pytorch,rails,raspberrypi,ruby,rails,&perline=15)](#)
